...
<body style="background-color: #F0FFFF;">
    ...
    <header class="d-flex bg-danger justify-content-between align-items-center text-white p-1 text-center">
        ...
        <div class="dropdown">
            ...
            <img class="picc" src="images/1.PNG" width="700"> Me
            </a>
    ...
    <div class="d-flex justify-content-center mt-3">
        <div class="">
            <div class="cover">
                <img src="images/2.jpg" width="700" height="200">
                <div class="profile" style="margin-top:-4.9rem; margin-left:1rem;">
                    <img class="profile-pic " src="images/3.jpg" width="700">
                    <p class="fw-bold text-white" style="margin-top:-3rem; margin-left:6.5rem;">UWIKESHA Sylvie</p>
                </div>
            </div>
            <div class="change">
